...
function updateEmployee(employee) {
  ...
  return (
    ...
    <Nav/>
        <Grid2 container spacing={13} sx={{ padding: 10 }}>
            {employee.map((employee) => (
                <Grid2 item xs={12} sm={13} md={4} key={employee.EmployeeId}>
                    <Card sx={{ height: '100%',width:300, display: 'flex', flexDirection: 'column' }}>
                        <CardMedia
                        ...
                        <Typography gutterBottom variant="h5" component="div" sx={{fontWeight: 700}}>
                            ...
                            <Button variant="contained" onClick={() => updateEmployee(employee)}>EDIT</Button>
